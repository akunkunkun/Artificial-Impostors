...
int main(int argc, char **argv)
{
	...
	Parameters::GetInstance()->AddUsersRange(1, 5); // consider simulated users ID 1, 2, 3, 4, 5
	Parameters::GetInstance()->SetTimestampsRange(1, 48); // consider timestamps 1, 2, 3, ..., 40
	Parameters::GetInstance()->SetLocationstampsRange(1, 8); // consider locationstamps 1, 2, 3, ..., 8
